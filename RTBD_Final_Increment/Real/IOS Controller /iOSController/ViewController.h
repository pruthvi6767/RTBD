...
@interface ViewController : UIViewController <SpeechKitDelegate, SKRecognizerDelegate,RoboMeDelegate,UIImagePickerControllerDelegate, UINavigationControllerDelegate>
{
