...
define('CONSUMER_KEY', 'kAs8EDxw3ANzxhFD4cYdkkUJJ');
define('CONSUMER_SECRET', '8dsdPkG3dTbIVmwQQ7CnZbhFfGYiTrGFfixyqwLwWNm8oGhdeq');
define('OAUTH_CALLBACK', 'http://52.33.82.92/twitter.php');
// start the session
session_start();
