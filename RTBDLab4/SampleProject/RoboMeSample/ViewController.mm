...
- (void)perform:(NSString *)command {
    ...
    NSLog(@"The array1 is %@",array[0]);
    NSLog(@"The array2 is %@",array[1]);
    ...
    else if ([array[0] isEqualToString:@"TWEET1"])
    {
        NSLog(@"t1 %@",array[1]);
        NSString *tweet1=[NSString stringWithFormat:@"%@ - %@ %@",array[1],array[2],array[3]];
        NSString *speech1 = [NSString stringWithFormat:@"Popular tweet for ten seconds %@",array[1]];
        _top10Label.text=tweet1;
        self.synthesizer=[[AVSpeechSynthesizer alloc]init];
        AVSpeechUtterance *utterance =[[AVSpeechUtterance alloc] initWithString:speech1];
        utterance.rate=0.2;
        [self.synthesizer speakUtterance:utterance];
    ...
    else if ([array[0] isEqualToString:@"TWEET2"])
    {
        NSLog(@"t2 %@%@",array[2],array[3]);
        NSString *tweet2 = [NSString stringWithFormat:@"%@ - %@ %@",array[1],array[2],array[3]];
        _top30Label.text=tweet2;
        self.synthesizer=[[AVSpeechSynthesizer alloc]init];
        NSString *speech2 = [NSString stringWithFormat:@"Popular tweet for thirty seconds %@",array[1]];
        _top30Label.text=tweet2;
        AVSpeechUtterance *utterance =[[AVSpeechUtterance alloc] initWithString:speech2];
        utterance.rate=0.2;
        [self.synthesizer speakUtterance:utterance];
    
        }
    else if ([array[0] isEqualToString:@"COUNT1"])
    {
        NSLog(@"c1 %@",array[1]);
        NSString *count1 = [NSString stringWithFormat:@"Total Tweets in 10 sec : %@ ",array[1]];
        _top10Count.text=count1;
    }
    else if ([array[0] isEqualToString:@"COUNT2"])
    {
        NSLog(@"c2 %@",array[1]);
        NSString *count2 = [NSString stringWithFormat:@"Total Tweets in 30 sec : %@ ",array[1]];
        _top30Count.text=count2;
    }
